...
class ProcessResult:
    ...
    Shared by :class:`~milknado.loop._runner.RunResult` and
    :class:`~milknado.loop._agent.AgentResult` so the common *success*
...
def warn(message: str) -> None:
    """Print a warning message to stderr with the ``milknado.loop:`` prefix.
