...
class RunFacadePort(Protocol):
    ...
    def latest_terminal(self, node_id: int, run_id: str, /) -> Mapping[str, object] | None: ...


class StaleRunFacadePort(Protocol):
    def finish(self, run_id: str, result: RunResult, /) -> None: ...
    def for_node(self, node_id: int, /) -> Iterable[Mapping[str, object]]: ...
...
class RunFinalizerFacadePort(Protocol):
    def finish(self, run_id: str, result: RunResult, /) -> None: ...
    def get(self, run_id: str, /) -> Mapping[str, object] | None: ...
