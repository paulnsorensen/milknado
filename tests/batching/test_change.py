...
def test_symbol_ref_is_frozen() -> None:
    ...
    with pytest.raises(FrozenInstanceError):
        s.name = "baz"  # pyright: ignore[reportAttributeAccessIssue]  # type: ignore[assignment]
...
def test_new_relationship_is_frozen() -> None:
    ...
    with pytest.raises(FrozenInstanceError):
        rel.reason = "new_call"  # pyright: ignore[reportAttributeAccessIssue]  # type: ignore[assignment]
...
def test_batch_is_frozen() -> None:
    ...
    with pytest.raises(FrozenInstanceError):
        b.index = 1  # pyright: ignore[reportAttributeAccessIssue]  # type: ignore[assignment]
...
def test_symbol_spread_is_frozen() -> None:
    ...
    with pytest.raises(FrozenInstanceError):
        ss.spread = 0  # pyright: ignore[reportAttributeAccessIssue]  # type: ignore[assignment]
...
def test_batch_plan_is_frozen() -> None:
    ...
    with pytest.raises(FrozenInstanceError):
        p.solver_status = "INFEASIBLE"  # pyright: ignore[reportAttributeAccessIssue]  # type: ignore[assignment]
