...
def test_codex_golden_stream() -> None:
    ...
    assert (
        adapter.extract_completion_signal(result_text=None, stdout=text, user_signal="COMPLETE")
        is True
    )
    assert (
        adapter.extract_completion_signal(result_text=None, stdout=text, user_signal="MISSING")
        is False
    )
...
def test_copilot_golden_stream() -> None:
    ...
    assert (
        adapter.extract_completion_signal(result_text=None, stdout=text, user_signal="NOPE")
        is False
    )
...
def test_opencode_golden_stream() -> None:
    ...
    assert (
        adapter.extract_completion_signal(result_text=None, stdout=text, user_signal="ABSENT")
        is False
    )
