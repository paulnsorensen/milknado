...
def test_bulk_node_and_latest_result_queries_preserve_contract(tmp_path: Path) -> None:
    ...
    _ = graph.deposit_run_message("run-first", "result", "old", "2026-01-01T00:00:01+00:00")
    _ = graph.deposit_run_message("run-first", "result", "new", "2026-01-01T00:00:02+00:00")
    _ = graph.deposit_run_message("run-second", "result", "second", "2026-01-01T00:00:01+00:00")
