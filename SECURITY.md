...
<https://github.com/paulnsorensen/milknado/security/advisories/new>
...
- Released artifacts produced from this repo.

Out of scope:

- Third-party dependencies — please report those upstream.
- Self-hosted deployments configured outside the project's documented
  defaults.
